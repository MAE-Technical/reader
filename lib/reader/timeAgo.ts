 ...
 * deliberately not react-timeago-i18n's own "6 hours ago" output, which
 * reads fine as a full sentence but is too wide for a single metadata row
 * sitting next to an author name. */
