...
export const MATERIAL_SUMMARY_COLUMNS =
  "id, slug, material_type, title, author, description, cover_url, thumbnail_url, google_meta_data, openlibrary_meta_data, cover_source, language, published_year, page_count_estimate, categories, created_at";

/** Metadata required by detail pages, excluding TOC/spine payloads. */
export const MATERIAL_DETAIL_COLUMNS =
  `${MATERIAL_SUMMARY_COLUMNS}, narrator_count, json_storage_path, status, updated_at`;
