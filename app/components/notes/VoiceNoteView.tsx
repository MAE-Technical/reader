 ...
 * blob back from its own src (a blob: URL for a just-recorded draft, or a
 * real file URL for a persisted one) since decoding it into bars needs the
 * raw audio data, not just a src. Shared by every context that renders a
 * saved voice note (the reader's own note panel, a book's aggregate notes
 * list, and eventually a community note on the home feed). */
